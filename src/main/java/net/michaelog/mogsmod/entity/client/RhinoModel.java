package net.michaelog.mogsmod.entity.client;


import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.michaelog.mogsmod.entity.animations.ModAnimatinDefinitions;
import net.michaelog.mogsmod.entity.custom.RhinoEntity;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(ModAnimatinDefinitions.RHINO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
		this.animate(((RhinoEntity) entity).idleAnimationState, ModAnimatinDefinitions.RHINO_IDLE,ageInTicks, 1f);
	}
